namespace SecureGroup.Utility
{
    public class ConnectionString
    {
        ...
        private static string cName = "Data Source=10.200.109.160; Initial Catalog=SecureGroupLive;User ID=sa;Password=Shyam@2023;Encrypt=false;TrustServerCertificate=true";
